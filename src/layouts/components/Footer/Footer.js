...
function Footer() {
    const pagesList = categories.pages;
        ...
        <>
                ...
                <div className="container">
                    <div className="row lg-gutters">
                        <div className="col col-6 col-sm-12">
                            <h4 className={cx('title')}>Về 8YO</h4>
                            <div className={cx('content')}>
                                <div className="row lg-gutters">
                                    <div className="col col-6 col-sm-6">
                                        <p>
                                            Đưa đến một chất lượng sản phẩm hoàn hảo với một giá
                                            thành hợp lí nhất. Luôn đặt khách hàng lên trên cả lợi
                                            nhuận. Tự hào là một Local Brand nhận được sự hài lòng
                        ...
                        <div className="col col-3 col-sm-6">
                            ...
                            <div className={cx('content-support')}>
                                <ul>
                                    {pagesList.map((page) => {
                                        return (
                                            <li key={page.id}>
                            ...
                            <div className={cx('content')}>
                                <div className={cx('info')}>
                                    ...
                                    <div className={cx('box-content')}>
                                        ...
                                        <u>8yo.studio@gmail.com</u>
                                    </div>
                                </div>
                                <h4 className={cx('fter-title')}>Follow 8YO nha bạn hiền!</h4>
            ...
            <div className={cx('bot-wrapper')}>
                <p className={cx('copyright')}>
                    ...
                    <a href="https://8yostudio.com">8YO Studio</a>
                    <span>. </span>
